...
export default function AdminQuoteChatPage() {
        ...
        {loading_chat ? (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-2xl font-bold">Quote Chat</h1>
                <p className="text-muted-foreground">
                  Communicate with the customer about their quote request
                </p>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" asChild>
                  <Link href={`/admin/quotes/${params.id}`}>
                    View Details
                  </Link>
                </Button>
              </div>
            ...
            <Card className="min-h-[600px] flex flex-col">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Messages
                  <Badge variant="secondary">{chatData.messages.length}</Badge>
                </CardTitle>
                <CardDescription>
                  Chat history for this quote request
                </CardDescription>
              </CardHeader>
